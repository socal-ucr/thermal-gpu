...
//    cudaMemcpy(d_C, h_C, sizeof(float), cudaMemcpyHostToDevice);
    ...
    std::string cmd = GPUJOULE_DIR"/nvml_power_monitor/example/power_monitor 5 > "GPUJOULE_DIR"/energy_model_ubench/energy_model_data/data_movement_energy/shd_mem/fadd_shd_100_0_64p_asm_power.txt &";
