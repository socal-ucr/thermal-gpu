...
#include "../include/repeat.h"  // helper for shared functions common to CUDA SDK samples
...
// Device code
__global__ void L1(int* A, int* C, int N){
...
__global__ void L1_ALL(int* A, int* C, int N){
    int tid = blockDim.x * blockIdx.x + threadIdx.x;
    //Do Some Computation
...
__global__ void L2(int* A, int* C, int N){
    int tid = blockDim.x * blockIdx.x + threadIdx.x;
    //Do Some Computation
...
__global__ void L2_ALL(int* A, int* C, int N){
    int tid = blockDim.x * blockIdx.x + threadIdx.x;
    //Do Some Computation
